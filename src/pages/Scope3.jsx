  ...
  return (
    <div className="shadow rounded">
      ...
      <div className="grid grid-cols-2 p-5">
        <div className="md:border-r md:pr-2">
          ...
          <input
            ...
            value={scope3["1a"]}
            onChange={(e) => setScope3({ ...scope3, "1a": e.target.value })}
            type="number"
          />
          ...
          <input
            className="border-b border-[#2dbf1d] w-full py-2 pl-3 outline-none mb-5"
            value={scope3["1b"]}
            onChange={(e) => setScope3({ ...scope3, "1b": e.target.value })}
            type="number"
          />
      ...
      <input
        className="border-b border-[#2dbf1d] w-full py-2 pl-3 outline-none mb-5"
        value={scope3["2a"]}
        onChange={(e) => setScope3({ ...scope3, "2a": e.target.value })}
        type="number"
      /> */}
          ...
          <input
            className="border-b border-[#2dbf1d] w-full py-2 pl-3 outline-none mb-5"
            value={scope3["2b"]}
            onChange={(e) => setScope3({ ...scope3, "2b": e.target.value })}
            type="number"
          />
      ...
      <input
        className="border-b border-[#2dbf1d] w-full py-2 pl-3 outline-none mb-5"
        value={scope3["3a"]}
        onChange={(e) => setScope3({ ...scope3, "3a": e.target.value })}
        type="number"
      /> */}
          ...
          <Select
            value={scope3[4]}
            set={(e) => setScope3({ ...scope3, 4: e.target.value })}
          />
          ...
          <Select
            value={scope3["4a"]}
            set={(e) => setScope3({ ...scope3, "4a": e.target.value })}
          />
          ...
          <input
            className="border-b border-[#2dbf1d] w-full py-2 pl-3 outline-none mb-5"
            value={scope3["4b"]}
            onChange={(e) => setScope3({ ...scope3, "4b": e.target.value })}
            type="number"
          />
          ...
          <input
            className="border-b border-[#2dbf1d] w-full py-2 pl-3 outline-none mb-5"
            value={scope3["4c"]}
            onChange={(e) => setScope3({ ...scope3, "4c": e.target.value })}
            type="number"
          />
        </div>
      </div>
